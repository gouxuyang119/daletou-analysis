...
import { TrendingUp, BarChart3, Target, Brain, Download, RefreshCw, Database, Calculator, AlertCircle, Thermometer, PieChart, MessageCircle, Archive } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">超级大乐透智能分析系统</h1>
                <p className="text-sm text-gray-500">专业走势分析 · 智能预测 · 奖金计算</p>
              </div>
            </div>
              ...
              <button
                ...
                className={`flex items-center space-x-2 py-4 px-1 border-b-2 text-sm transition-colors ${
                  activeTab === tab.id
                    ...
                    : 'border-transparent text-black hover:text-gray-700 hover:border-gray-300 font-medium'
                }`}
              >
                {tab.icon}
                <span>{tab.label}</span>
