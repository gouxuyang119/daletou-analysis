              ...
              <div className="flex space-x-2">
                {newDrawInput.frontNumbers.map((num, index) => (
                  <input
                    ...
                    className="w-12 h-12 text-center border border-red-300 rounded-lg text-red-600 font-bold"
                    maxLength={2}
                  />
                ))}
              </div>
              ...
              <div className="flex space-x-2">
                {newDrawInput.backNumbers.map((num, index) => (
                  <input
                    ...
                    placeholder={(index + 1).toString()}
                    className="w-12 h-12 text-center border border-blue-300 rounded-lg text-blue-600 font-bold"
                    maxLength={2}
                  />
                ))}
              </div>
