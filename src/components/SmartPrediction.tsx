    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div>
              ...
              >
                ...
                <span>{uploadStatus.single ? '已上传单式票' : '上传单式票'}</span>
              </button>
            </div>
            <div>
              <input
              ...
              >
                <Upload className="w-4 h-4" />
                <span>{uploadStatus.multiple ? '已上传复式票' : '上传复式票'}</span>
              </button>
            </div>
            <div>
              <input
              ...
              >
                <Upload className="w-4 h-4" />
                <span>{uploadStatus.nonWinning ? '已上传不中组合' : '上传不中组合'}</span>
              </button>
            </div>
          </div>
          ...
          {/* 按钮下方的说明文字 */}
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="text-center text-xs text-gray-500">Excel文件含备注"单式票"</div>
            <div className="text-center text-xs text-gray-500">Excel文件含备注"复式票"</div>
            <div className="text-center text-xs text-gray-500">Excel文件含备注"不中"</div>
          </div>
