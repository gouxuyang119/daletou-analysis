    ...
    <div className="bg-white rounded-xl shadow-lg h-[600px] flex flex-col">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        ...
        <div className="flex items-center space-x-2">
          <button
            onClick={clearChat}
            className="p-3 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors touch-manipulation min-h-[44px]"
            title="清空对话"
          >
        ...
        <div className="flex items-end space-x-2">
          <div className="flex-1 relative">
            <input
              ...
              placeholder="输入您的问题..."
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none touch-manipulation text-base min-h-[44px]"
              disabled={isLoading}
            />
          </div>
          
          <label className="p-3 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg cursor-pointer transition-colors touch-manipulation min-h-[44px] flex items-center justify-center">
          ...
          <button
            ...
            className="p-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors touch-manipulation min-h-[44px] flex items-center justify-center"
          >
