  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-4 md:p-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 space-y-3 md:space-y-0">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
            <div className="flex items-center space-x-2">
              ...
              <label className="text-sm text-gray-600 whitespace-nowrap">显示期数:</label>
              <div className="relative">
                <input
                  ...
                  className="w-20 border border-gray-300 rounded px-3 py-2 text-sm touch-manipulation"
                />
              </div>
            </div>
          </div>
        ...
        <div className="mb-4 p-3 bg-gray-50 rounded-lg">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-2 text-xs">
            <div className="flex items-center space-x-1">
              ...
              <span className="whitespace-nowrap">红球开奖号码</span>
            </div>
            <div className="flex items-center space-x-1">
              <div className="w-5 h-5 bg-red-800 rounded-full flex-shrink-0"></div>
              <span className="text-xs">红球连续3期以上/连号/斜连号</span>
            </div>
            <div className="flex items-center space-x-1">
              <div className="w-5 h-5 bg-blue-500 rounded-full flex-shrink-0"></div>
              <span className="whitespace-nowrap">蓝球开奖号码</span>
            </div>
            <div className="flex items-center space-x-1">
              <div className="w-5 h-5 bg-blue-900 rounded-full flex-shrink-0"></div>
              <span className="text-xs">蓝球连续3期以上/连号/斜连号</span>
            </div>
            <div className="flex items-center space-x-1">
              <div className="w-5 h-5 bg-gray-200 border rounded text-center text-xs leading-5 flex-shrink-0">5</div>
              <span className="whitespace-nowrap">遗漏期数</span>
            </div>
          </div>
        </div>
        ...
        {/* 走势图表格 */}
      <div ref={tableRef} className="bg-gray-50 rounded-lg shadow overflow-auto max-h-[600px] md:max-h-[700px]">
        <div className="md:hidden mb-2 p-2 bg-blue-50 rounded text-xs text-blue-700">
          💡 提示：表格可左右滑动查看完整内容
        </div>
        <table className="text-xs border-collapse w-full min-w-[800px]" style={{ fontSize: '10px' }}>
